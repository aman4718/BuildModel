...
const BuildModel = () => {
  ...
  const validate = () => {
    ...
    else if (!/^[0-9]{10}$/.test(formData.phone)) newErrors.phone = "Invalid phone number. Please enter a 10-digit phone number.";

    if (!formData.dob) newErrors.dob = "Date of birth is required";
    else if (new Date(formData.dob) > new Date()) newErrors.dob = "Invalid date of birth. Please enter a past date.";
